...
public class ChatMemoryTest {
    ...
    /**
     * 测试ChatMemory, fail case.
     * LLM can remember the previous conversation by Memory.
     */
    @Test
    public void testChatMemory() {
        String answer1 = assistant2.chat("我是环环");
    ...
    /**
     * 测试ChatMemory, ok case1(easy implement).
     *
     * LLM can remember the previous conversation by Memory.
     */
    @Test
    ...
    /**
     * 测试ChatMemory, ok case2(use langchain4j).
     * To use ChatMemory to implement complex conversation remember.
     * LLM can remember the previous conversation by Memory.
     */
    @Test
    ...
    public void testChatMemory4() {
        String answer1 = memoryChatAssistant.chat(1, "我是环环");
        System.out.println(answer1);
        String answer2 = memoryChatAssistant.chat(1, "我是谁");
        System.out.println(answer2);
    }
