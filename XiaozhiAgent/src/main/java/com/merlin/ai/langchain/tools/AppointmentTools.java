package com.merlin.ai.langchain.tools;


import com.merlin.ai.langchain.entity.Appointment;
import com.merlin.ai.langchain.service.AppointmentService;
...
public class AppointmentTools {
    ...
    //@Tool(name="预约挂号", value = "根据参数，先执行工具方法queryDepartment查询是否可预约，并整理给用户目前是否可预约。并让用户确认所有预约信息，用户确认后再进行预约。")
    ...
    //@Tool(name="bookAppointment", value = "根据参数，先执行工具方法queryDepartment查询是否可预约，并整理给用户目前是否可预约。并让用户确认所有预约信息，用户确认后再进行预约。")
