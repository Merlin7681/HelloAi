package com.merlin.ai.langchain;
...
public class RAGTest {
    ...
    public void testReadDocument() {
        ...
        Document document = FileSystemDocumentLoader.loadDocument(Conf.knowledgePath +"测试.txt");
        System.out.println(document.text());
    }

    @Test
    public void testReadDocument2() {
        //使用FileSystemDocumentLoader读取指定目录下的知识库文档
        //并使用默认的文档解析器TextDocumentParser对文档进行解析
        ...
        List<Document> documents = FileSystemDocumentLoader.loadDocuments(Conf.knowledgePath, pathMatcher, new TextDocumentParser());
    ...
    public void testReadDocumentAndStore() {
        ...
        Document document = FileSystemDocumentLoader.loadDocument(Conf.knowledgePath + "人工智能.md");
     ...
     */
    @Test
    public void testDocumentSplitter() throws IOException {
    ...
    public void testTokenCount() {
        ...
        //OpenAiTokenCountEstimator tokenizer = new OpenAiTokenCountEstimator();
